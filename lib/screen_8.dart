...
import 'package:katapult_screens/screen9.dart';
                                  ...
                                  child: Container(
                                    child: Column(
                                      children: [
                                        ...
                                        SizedBox(height: 8.0,),
                                        Container(
                                          padding:  EdgeInsets.only(top: 0,bottom: 1.5.h),                                  child: Text("Select minimum 5 topics", style: TextStyle(fontFamily: 'Montserrat',fontWeight: FontWeight.w600,fontSize: 10.0,color: Color(0xffFFFFFF),),),),
                                        Padding(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          ...
                                                          Text(selectedList[index],style: TextStyle(fontFamily: 'Montserrat',
                                                            fontWeight: FontWeight.w600,color: Color(0xffFFFFFF),fontSize: 8,),),
                                                          SizedBox(width: 10,),
                                                        ],
                                                      ),
                                                    ),
                                                              ...
                                                              children: [
                                                                Card(
                                                                  ...
                                                                  child: InkWell(
                                                                    onTap:(){
                                                                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                                                                        builder: (context) => Screen9(snapshot.data[index],selectedList),
                                                                      ));
