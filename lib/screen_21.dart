...
class Screen21 extends StatefulWidget {
  ...
  Screen21(this.user,this.selectedList,this.username,this.name1,this.correct,this.fifty,this.multiplier);
}
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: RaisedButton(
                                      ...
                                      onPressed: (){
                                        Navigator.of(context).pushReplacement(MaterialPageRoute(
                                          builder: (context) => Screen22(widget.selectedList,widget.username,widget.name1,widget.correct,widget.fifty,widget.multiplier),
                                        ));
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                ...
                                                                'Montserrat',fontWeight: FontWeight.w600,color: Color(0xffBE15A0),fontSize: 8,),),
                                                                SizedBox(width: 10,),
                                                              ],
                                                            ),
                                                          ),
                                                                      ...
                                                                      children: [
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            //     onTap:(){
                                                                            //       // Navigator.of(context).pushReplacement(MaterialPageRoute(
                                                                            //       //   builder: (context) => Screen21(snapshot.data[index],widget.selectedList,widget.name,widget.name1),
                                                                            //       // ));
                                                                            //
                                                                            //     },
                                                                            //     child:Container(
