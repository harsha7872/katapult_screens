...
class Screen20 extends StatefulWidget {
  ...
  Screen20(this.user,this.selectedList,this.username,this.name1,this.correct,this.fifty,this.multiplier);
}
                                                                            ...
                                                                            Card(
                                                                              ...
                                                                              child: InkWell(
                                                                                onTap:(){
                                                                                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                                                                                    builder: (context) =>
                                                                                        Screen21(snapshot.data[index],widget.selectedList,widget.username,widget.name1,widget.correct,widget.fifty,widget.multiplier),
                                                                                  ));
