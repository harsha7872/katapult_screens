...
import 'package:katapult_screens/screen59.dart';

import 'MainPage_11.dart';
import 'constants.dart';

class Screen55 extends StatefulWidget {
  Screen55({Key key}) : super(key: key);
  @override
  _Screen55State createState() => new _Screen55State();
}
      ...
      body:SingleChildScrollView(
          child: Container(decoration: BoxDecoration(
              image: DecorationImage(
                  image: NetworkImage(Constant.base_url+"getPdfFile/bcImg.png"),
                  fit: BoxFit.cover)),
              child:  Container(
                        ...
                        child: Center(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.only(top:15.0),
                                child: Text("Sorry, You lost the game",style: TextStyle(color: Color(0xff3644BA),fontSize: 18,fontWeight: FontWeight.w700,
                                    fontFamily: 'Montserrat'),),
                              ),
                              SizedBox(height: 15,),
                              Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Column(children:[ Text("Your Score Card",style: TextStyle(color: Color(0xff04D9F8),fontSize: 21,fontWeight: FontWeight.w700,
                                          fontFamily: 'Montserrat'),),
                                        Text("Total Questions Answered : 15",style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.w700,
                                            fontFamily: 'Montserrat'),),
                                      ]),
                                          ...
                                          children: [
                                            Card(
                                              ...
                                              child: Container(
                                                ...
                                                height: 35,
                                                child: Text(
                                                  "30",style: TextStyle(color: Color(0xffC10B0B),fontSize: 10,fontWeight: FontWeight.w600,
                                                    fontFamily: 'Montserrat'),
                                                ),
                                              ),
                                            ),
                                          ...
                                          children: [
                                            Card(
                                              ...
                                              child: Container(
                                                ...
                                                height: 35,
                                                child: Text(
                                                  "750",style: TextStyle(color: Color(0xff3644BA),fontSize: 10,fontWeight: FontWeight.w600,
                                                    fontFamily: 'Montserrat'),
                                                ),
                                              ),
                                            ),
                                          ...
                                          children: [
                                            Card(
                                              ...
                                              child: Container(
                                                ...
                                                height: 35,
                                                child: Text(
                                                  "1500",style: TextStyle(color: Color(0xffB71570),fontSize: 10,fontWeight: FontWeight.w600,
                                                    fontFamily: 'Montserrat'),
                                                ),
                                              ),
                                            ),
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Column(
                                          children: [
                                            Container(
                                                child: Text("30",style: TextStyle(fontSize: 10.0,color: Color(0xffFDAC88),fontWeight: FontWeight.w600,
                                                    fontFamily: 'Montserrat'),)),
